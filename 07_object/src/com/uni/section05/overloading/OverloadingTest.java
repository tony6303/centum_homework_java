...
public class OverloadingTest {
	...
	//기준이 되는 메소드
	public void test() {} // 메소드 시그니쳐 : test()	
	
	// 메소드 시그니쳐가 모두 동일해서 컴파일 에러.
	// public void test(){}
	// private void test(){}
	// public int test() {return 0;}
	
	public void test(int num) {} // 올바른 오버로딩
	
	//public void test(int num2) {} 
	
	public void test(int num, int num2) {} // 올바른 오버로딩
	
	public void test(int num, String str) {} // 올바른 오버로딩
	
	public void test(String str, int num) {} // 올바른 오버로딩
