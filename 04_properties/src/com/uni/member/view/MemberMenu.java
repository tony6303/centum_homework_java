...
public class MemberMenu {
	...
	public void mainMenu() {
		...
		do {
			...
			System.out.println("7.탈퇴 회원 조회");// SELECT
	...
	private Member inputMember() { // 반환형 Member
		Member m = new Member();
	...
	public void displayMemberArrayList(ArrayList<Member> list) {
