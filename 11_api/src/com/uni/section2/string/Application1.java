...
public class Application1 {
	...
	public static void main(String[] args) {
		/* charAt() : 해당 문자열의 특정 인덱스에 해당하는 문자를 반환한다. 
	      ...
	      /*대문자와 소문자는 소문자97 과 대문자65 는  32만큼 차이가 난다.*/
	      System.out.println("compareTo() : " + (str2.compareTo(str4)));      //32
	      System.out.println("compareTo() : " + (str4.compareTo(str2)));      //-32//앞이 더작으니 음수가나옴
	      ...
	      System.out.println("compareToIgnoreCase() : " + (str5.compareToIgnoreCase(str4)));
